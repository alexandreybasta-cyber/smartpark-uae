...
const STATS = [
  ...
  { value: '0', unit: '', label: 'Inspectors Needed' },
];
...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center text-center overflow-hidden pt-[120px] pb-20 px-8">
      {/* Background gradient */}
      <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_0%,rgba(0,229,160,0.06)_0%,transparent_50%),radial-gradient(ellipse_60%_40%_at_80%_80%,rgba(59,130,246,0.04)_0%,transparent_50%),linear-gradient(180deg,#f0fdf4_0%,#ecfdf5_100%)]" />
      {/* Grid pattern */}
      <div
      ...
      <div className="relative z-10 max-w-[800px]">
        {/* Tag */}
        <div className="inline-flex items-center gap-2 px-5 py-2 rounded-3xl mb-8 bg-sp-bg-3 border border-emerald-200 text-[13px] text-sp-text-2 font-medium">
        ...
        <p className="text-lg text-sp-text-2 max-w-[580px] mx-auto mb-10 leading-relaxed font-normal">
          Light-powered IoT sensors, edge AI, and agentic intelligence — real-time spot availability for drivers and automated enforcement for authorities. No inspectors needed.
        </p>
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          ...
          <a
            ...
            className="px-8 py-3.5 rounded-xl text-[15px] font-semibold bg-transparent text-sp-text-1 border border-emerald-200 inline-flex items-center gap-2 hover:border-sp-text-3 hover:bg-sp-bg-3 transition-all no-underline"
          >
        ...
        {/* Stats */}
        <div className="flex gap-12 justify-center mt-16 pt-12 border-t border-emerald-200 flex-wrap">
          {STATS.map((stat) => (
            <div key={stat.label}>
